...
class Game {
	...
	public static void panel_game() {
		...
		for (int i = 0; i <= 2; i++) {
			...
			icon_path[i] = System.getProperty("user.dir") + "/rock_paper_scissor" + "/images/" + i + ".png";
	...
	public static void compute_winner(int choice_human) {
		...
		JLabel image_human = new JLabel(
				new ImageIcon(System.getProperty("user.dir") + "/rock_paper_scissor" + "/images/"
						+ (choice_human - 1) + ".png"));
